...
|$\exists x \ S(x)$|There exists a somone who is a student.|
|$\forall x \ S(x)$|All people are students.|
|$\neg \exists x \ S(x)$|There does not exist someone who is a student.|
|$\exists x \ \neg S(x)$|There exists somone who is not a student|
